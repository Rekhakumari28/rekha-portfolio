            ...
            <div className="card bg-light  h-100 border-0 shadow-sm project">
              ...
              <div className="card-body p-4">
                ...
                <p className="card-text text-muted">
                  ShoeSanctuary is simple website showcasing collection of
                  shoes. This website build with using full-stack technologies
                  that demonstrate both frontend and backend expertise. its key
                  features like product browsing, shopping cart management,
                  address management, user profile management, checkout, filtering
                  product by price, rateing, category and wishlist management.
                </p>
            ...
            <div className="card bg-light  h-100 border-0 shadow-sm project">
              ...
              <div className="card-body p-4">
                ...
                <p className="card-text text-muted">
                  ...
                  owners, set deadlines, and organize work using tags. With a
                  user-friendly interface powered by React, it supports
                  authentication, dynamic filtering, URL-based queries, and
                  reporting features to track tasks, progress and team
                  productivity.
                </p>
            ...
            <div className="card bg-light  h-100 border-0 shadow-sm project">
              ...
              <div className="card-body p-4">
                ...
                <p className="card-text text-muted">
                  ...
                  lead. Key features include sales agent assignment, lead
                  stage tracking, and collaborative commenting for enhanced
